...
const InstallationListPageView = () => {
  ...
  const handleSearch = (event) => {
    ...
    setSearchTerm(value);
    if (value === '') {
      setFilteredData(InstallationData);
    } else {
          ...
          <>
            ...
            >
              <MenuItem
                onClick={() => {
                  handleCloseOpenMenu();
                  navigate(`/dashboard/update-installation/${record.id}`);
                }}
              >
  ...
  return <Card>
    ...
    <FlexBetween flexWrap="wrap" gap={2} p={2} pt={2.5}>
      <Stack direction="row" alignItems="center">
        ...
        <H5 fontSize={16}>Installation List</H5>
      </Stack>

      <Button variant="contained" startIcon={<Add />} onClick={() => navigate("/dashboard/create-installation")}>
        Add Installation
      </Button>
    </FlexBetween>
    ...
    <Wrapper gap={2} px={2} pb={3}>
      ...
      <TextField
        fullWidth
        label="Search installation by name..."
        value={searchTerm}
    ...
    <div>
      ...
      >
        <Box sx={style}>
          <H6 fontSize={18}>Delete Installation</H6>
...
export default InstallationListPageView;