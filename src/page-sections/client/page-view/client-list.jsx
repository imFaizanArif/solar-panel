...
const ClientListPageView = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 150,
      dataIndex: 'monthly_consumption_units',
      key: '2',
      sorter: {
        compare: (a, b) => a.name.localeCompare(b.name),
        multiple: 3,
          ...
          <>
            ...
            >
              <MenuItem
                onClick={() => {
                  handleCloseOpenMenu();
                  navigate(`/dashboard/update-client/${record.id}`);
                }}
              >
  ...
  return <Card>
    ...
    <FlexBetween flexWrap="wrap" gap={2} p={2} pt={2.5}>
      <Stack direction="row" alignItems="center">
        ...
        <H5 fontSize={16}>Client List</H5>
      </Stack>

      <Button variant="contained" startIcon={<Add />} onClick={() => navigate("/dashboard/create-client")}>
        Add Client
      </Button>
    </FlexBetween>
    ...
    <div>
      ...
      >
        <Box sx={style}>
          <H6 fontSize={18}>Delete Client</H6>
...
export default ClientListPageView;