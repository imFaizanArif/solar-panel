...
import Projects from "@/icons/sidebar/Projects";
          ...
          <>
            ...
            >
              <MenuItem
                onClick={() => {
                  handleCloseOpenMenu();
                  navigate(`/dashboard/update-structure/${record.id}`);
                }}
              >
  ...
  return <Card>
    ...
    <FlexBetween flexWrap="wrap" gap={2} p={2} pt={2.5}>
      <Stack direction="row" alignItems="center">
        <IconWrapper>
          <Projects color="primary" />
        </IconWrapper>

        <H5 fontSize={16}>Structure List</H5>
      </Stack>

      <Button variant="contained" startIcon={<Add />} onClick={() => navigate("/dashboard/create-structure")}>
        Add Structure
      </Button>
    </FlexBetween>
    ...
    <Wrapper gap={2} px={2} pb={3}>
      ...
      <TextField
        fullWidth
        label="Search Structure by name..."
        value={searchTerm}
    ...
    <div>
      ...
      >
        <Box sx={style}>
          <H6 fontSize={18}>Delete Structure</H6>
...
export default StructureListPageView;